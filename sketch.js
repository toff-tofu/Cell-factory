...
function preload(){
  ...
  dotsSprite = loadImage('assets/map icon.png')
  ATPSprite = loadImage('assets/atp.png');
  ADPSprite = loadImage('assets/adp.png');
  head = loadImage('assets/head.png')
  tableSprite = loadImage('assets/better table (maybe, idk).png')
  photonSprite = loadImage('assets/photon.png');
  PiSprite = loadImage('assets/Pi.png');
  H2OSprite = loadImage('assets/water.png');
  aketoglutarateSprite = loadImage('assets/a-ketoglutarate.png')
  acetaldehydeSprite = loadImage('assets/acetaldehyde.png')
  acetylcoaSprite = loadImage('assets/acetyl-coa.png')
  citricacidSprite = loadImage('assets/citric acid.png')
  co2Sprite = loadImage('assets/co2.png')
  electronSprite = loadImage('assets/electron.png')
  ethanolSprite = loadImage('assets/ethanol.png')
  excitedelectronSprite = loadImage('assets/excited electron.png')
  fadSprite = loadImage('assets/fad+_h2.png')
  friendSprite = loadImage('assets/friend.png')
  fumarateSprite = loadImage('assets/fumarate.png')
  g3pSprite = loadImage('assets/g3p.png')
  gdpSprite = loadImage('assets/gdp.png')
  glucoseSprite = loadImage('assets/glucose.png')
  gtpSprite = loadImage('assets/gtp.png')
  dustSprite = loadImage('assets/dust.png')
  isocitrateSprite = loadImage('assets/isocitrate.png')
  malateSprite = loadImage('assets/malate.png')
  nadSprite = loadImage('assets/nad+_h.png')
  nadpSprite = loadImage('assets/nadp+_h.png')
  oxaloacetateSprite = loadImage('assets/oxaloacetate.png')
  oxygenSprite = loadImage('assets/oxygen.png')
  pgaSprite = loadImage('assets/pga.png')
  protonSprite = loadImage('assets/proton.png')
  pyruvateSprite = loadImage('assets/pyruvate.png')
  rubpSprite = loadImage('assets/rubp.png')
  succinateSprite = loadImage('assets/succinate.png')
  succinylcoaSprite = loadImage('assets/succinyl-coa.png')
  platformMud = loadImage('assets/Untitled_Artwork 5.png');
  platformWater = loadImage('assets/Untitled_Artwork.png');
  platformBridge = loadImage('assets/Untitled_Artwork 4.png');
  ETC = loadImage('assets/blue blob.png');
  ETCGlyph = loadImage('assets/blue thing.png');
  ATPS = loadImage('assets/atp_synthase.png');
  ATPSglyph = loadImage('assets/thing for atp synthase.png');
  Chlor = loadImage('assets/chlorophyll.png');
  ChlorGlyph = loadImage('assets/limeRing.png');
  music[music.length] = loadSound('assets/menu.mp3');
  rubiscoSprite = loadImage('assets/rubisco.png');
  rubiscoGlyph = loadImage('assets/thing for rubisco.png');
  ckabpSprite = loadImage('assets/wierd six carbon thing from the calvin cycle that you most likely get to see one frame of.png');
  redoxGlyph = loadImage("assets/hason asked for this so idk why its in bere.png");
  redoxSprite = loadImage("assets/white thing.png");
  regenGlyph = loadImage("assets/hason asked for this so idk why its in bere.png");
  regenSprite = loadImage("assets/white thing.png");
  craftingSprite = loadImage("assets/Crafting_Table.png")
  mitoMud = loadImage('assets/mitochondria platform.png');
  mitoWater = loadImage('assets/mitochondria water.png');
  mitoBridge = loadImage('assets/mitochondria bridge.png');
  coaSprite = loadImage('assets/coa.png')
  mbg = loadImage('assets/mitochondri map background.png')
  cbg = loadImage('assets/chloroplast map background.png')
  star = loadImage('assets/star.png')
  exbox = loadImage('assets/end.png')
  info = loadImage('assets/info.png')
  play = loadImage('assets/play.png')
  protonBundle = loadImage('assets/proton bundle.png')
}
}
